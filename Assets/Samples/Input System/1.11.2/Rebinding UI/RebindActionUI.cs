    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        )
        {
            ...
            if (action.bindings[bindingIndex].isPartOfComposite)
                partName =
                    $"Zmiana akcji '{transform.GetChild(0).GetComponent<TextMeshProUGUI>().text.ToUpper()}'.";
            // partName = $"Zmiana '{action.bindings[bindingIndex].name}'. ";
        ...
        [Tooltip(
            "Text label that will receive the name of the action. Optional. Set to None to have the "
        ...
        [Tooltip(
            "Event that is triggered when an interactive rebind is complete or has been aborted."
        )]
        [SerializeField]
